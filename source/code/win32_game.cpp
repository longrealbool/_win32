...
{
  // TODO(Egor): Centering / black bars?
...
{
  // NOTE(Egor): This follows Raymond Chen's prescription
        ...
        int ShowCode)
{
  ...
  /* NOTE(Egor): 1080p display mode is 1920x1080 -> Half of that is 960x540
  ...
  */
  ...
  if(RegisterClassA(&WindowClass))
  {
    ...
    if(Window)
    {
      ...
      // TODO(Egor): Use MEM_LARGE_PAGES and
      // call adjust token privileges when not on Windows XP?
      
      // TODO(Egor): TransientStorage needs to be broken up
